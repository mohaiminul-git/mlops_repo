...
#         # with open(f"models/{model_info['model_path']}.pkl", 'rb') as f:
#         #     clf = pickle.load(f)
#         # Register the model
...
#             stage="Staging"
#         )
#         logging.debug(f'Model {model_name} version {latest_version.version} registered and transitioned to Staging.')
#     except Exception as e:
